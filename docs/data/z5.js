...
window.GOZ_Z5 = {
  ...
  moisture: [
    { id: 'dry', audio: 'z5_moisture_dry', name: 'Bardzo sucho', caption: 'Brakuje wilgoci potrzebnej do rozkładu.' },
    { id: 'moist', audio: 'z5_moisture_moist', name: 'Wilgotno', caption: 'Materiał jest wilgotny, a między składnikami pozostaje miejsce na powietrze.' },
    { id: 'wet', audio: 'z5_moisture_wet', name: 'Zalane', caption: 'Nadmiar wody utrudnia dostęp powietrza.' }
  ],
  wet: {
    items: [
